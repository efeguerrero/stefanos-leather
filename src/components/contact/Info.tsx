...
const Info = () => {
  return (
    <div>
      <Link href="https://maps.app.goo.gl/p5mgMDBBmTSUUPon8" target="_blank">
      ...
      <div className="mt-12 lg:mt-12">
        <div className="mt-4 flex  gap-6">
          ...
          <Link
            className="grid place-items-center text-gray-600 transition-colors duration-300 lg:hover:text-bravo"
            href="https://stefanosdeco.com/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
