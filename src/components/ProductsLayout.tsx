      ...
      <div className="bg-white">
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="border-gray-200 flex items-baseline justify-between border-b pb-6 pt-24">
              ...
              <div className="flex items-center">
                ...
                <button
                  type="button"
                  className="text-gray-400 hover:text-gray-500 -m-2 ml-5 p-2 sm:ml-7"
                >
                      ...
                      {({ open }) => (
                        <>
                          <h3 className="-my-3 flow-root">
                            <Disclosure.Button className="text-gray-400 hover:text-gray-500 flex w-full items-center justify-between bg-white py-3 text-sm">
                              <span className="text-gray-900 font-medium">
                                {section.name}
                              </span>
                              <span className="ml-6 flex items-center">
